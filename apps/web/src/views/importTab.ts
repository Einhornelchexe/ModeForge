  ...
  <div class="wb-workspace" style="gap: 12px; padding: 14px; overflow-y: auto;">
    ...
    <div style="flex: 1.2; min-width: 0; display: flex; flex-direction: column; gap: 12px;">
      <div class="mf-card" style="display: flex; flex-direction: column; gap: 10px;">
        ...
        <textarea data-k="zmxText" rows="9" placeholder="${esc(T.zmxPlaceholder)}" spellcheck="false" class="mf-textarea">${esc(imp.zmxText)}</textarea>
        <div style="display: flex; align-items: center; gap: 10px;">
    ...
    <div style="flex: 1; min-width: 0; display: flex; flex-direction: column; gap: 12px;">
      <div class="mf-card" style="display: flex; flex-direction: column; gap: 10px;">
        ...
        <textarea data-k="agfText" rows="7" placeholder="${esc(T.agfPlaceholder)}" spellcheck="false" class="mf-textarea">${esc(imp.agfText)}</textarea>
        <div style="display: flex; align-items: center; gap: 10px;">
          <div style="flex: 1;"></div>
