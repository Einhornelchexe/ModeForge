...
const en: Strings = {
  ...
  modeNote: "Ideal HG/LG mode order sets the envelope M². Field rendering of modes lands with the Field Mode UI.",
...
const de: Strings = {
  ...
  modeNote: "Ideale HG/LG-Modenordnung setzt das Envelope-M². Die Feld-Darstellung der Moden kommt mit der Field-Mode-UI.",
